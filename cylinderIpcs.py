...
class CylinderBoundary(SubDomain):
    ...
    def inside(self, x, on_boundary):
        ...
        return on_boundary and near((x[0] - self.x_cyl)**2 + (x[1] - self.y_cyl)**2, self.r**2)
# Load the mesh
...
ns_problem.create_function_spaces()
# Define the initial conditions
ns_problem.define_initial_conditions()
# Define the boundary conditions
ns_problem.define_boundary_condition()
# Define the Navier-Stokes form
ns_problem.define_form() 
#######################################################################################################################
# Name the variables for ParaView output and write to XDMF file
u_n, p_n = ns_problem.u_n, ns_problem.p_n
